...
type_info type_id() ENTT_NOEXCEPT {
    return type_info{
        type_seq<std::remove_reference_t<std::remove_cv_t<Type>>>::value(),
        type_hash<std::remove_reference_t<std::remove_cv_t<Type>>>::value(),
        type_name<std::remove_reference_t<std::remove_cv_t<Type>>>::value()
    };
}
